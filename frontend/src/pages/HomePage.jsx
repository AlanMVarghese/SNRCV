...
const HomePage = () => {
  return (
    <div className="w-full h-screen flex flex-col">
      {/* Navbar */}
      <header className="w-full p-4 bg-blue-500 text-white fixed top-0 left-0 flex justify-between items-center z-50">
      ...
      {/* Main Content */}
      <main className="flex-grow mt-20 p-6 bg-gray-100">
        {/* Hero Section */}
